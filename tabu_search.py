    ...
    for x in random_numbers:
        ...
        if block_1["id"] not in tabu_dict:
            ...
            if col_index-1 >= 0:
                ...
                if block_1["id"] != block_2["id"] and block_2["id"] not in tabu_dict:
            ...
            if list_mergeable != []:
                ...
                if list_mergeable[n_rand][0] == "column_split" or list_mergeable[n_rand][0] == "row_split":
                    ...
                    if block_1["id"] in tabu_dict:
                        del tabu_dict[block_1["id"]]
                    block_dict[new_block_1["id"]] = new_block_1
                    block_dict[new_block_2["id"]] = new_block_2
                    tabu_dict[new_block_1["id"]] = 1 + len(new_block_1["sequence_ids"]) * (new_block_1["end_column"] - new_block_1["begin_column"] + 1)
                    tabu_dict[new_block_2["id"]] = 1 + len(new_block_2["sequence_ids"]) * (new_block_2["end_column"] - new_block_2["begin_column"] + 1)
                    ...
                    if row_to_merge < row_index or column_to_merge < col_index:
                        ...
                        tabu_dict[new_block["id"]] = 1 + len(new_block["sequence_ids"]) * (new_block["end_column"] - new_block["begin_column"] + 1)
                        ...
                        if block_2["id"] in tabu_dict:
                            del tabu_dict[block_2["id"]]
